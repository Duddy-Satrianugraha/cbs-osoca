            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body form-group-separated">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <input type="text" class="form-control" name="nomor_station" value="{{ $template->nomor_station }}"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <input type="text" class="form-control" name="judul_station" value="{{ $template->judul_station }}"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <select class="form-control" name='tingkat_kemampuan_kasus'>
                                ...
                                <option value ='{{ $datu->name}}' {{ $template->tingkat_kemampuan_kasus == $datu->name ? 'selected' : ''}}> {{$datu->name}} - {{ $datu->value}}</option>
                                @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            @php  $kyds = explode(',', $template->komptensi_yang_diujikan); @endphp
                            @foreach($kyd as $data)

                            <label class="check">
                                <input type="checkbox" class="icheckbox" name="komptensi_yang_diujikan[]" value="{{ $data->name }}"
                                    @if (in_array($data->name, $kyds))
                                        checked
                                    @endif
                                />
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <label class="check">
                                <input type="checkbox" class="icheckbox" name="use_rmd" id="use_rmd_checkbox" value=1  @if($template->use_rmd) checked @endif />
                                <span></span> Gunakan
                            </label>
                        </div>
                    </div>
                    ...
                    <!-- Div yang akan ditampilkan jika dicentang -->
                         ...
                         <div id="rmd_detail" class="form-group" @if(! $template->use_rmd) style="display: none;" @endif>
                        ...
                        <div class="col-md-8 col-xs-12">
                           <select class="form-control" name='j_pasien'>
                                ...
                                <option value ='A' @if($template->j_pasien == 'A') selected @endif>Dewasa </option>
                                <option value ='C' @if($template->j_pasien == 'C') selected @endif>Anak-Anak </option>
