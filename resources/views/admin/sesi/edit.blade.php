...
@section('breadcrumb')
   ...
   <ul class="breadcrumb">
    ...
    <li ><a href="{{ route('admin.ujian.show', $sesi->ujian_id)}}">Daftar Sesi</a></li>
...
<div class="row">
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="form-horizontal" action="{{ route('admin.sesi.update', $sesi->id) }}" method="POST">
                @csrf
                @method('put')
                <input type="hidden" name="ujian_id" value="{{ $sesi->ujian_id }}">
            <div class="panel panel-default">
                ...
                <div class="panel-body form-group-separated">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <input type="text" class="form-control" name="name" value="{{ $sesi->name }}"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <input type="number" class="form-control" name="jml_lokasi" value="{{ $sesi->jml_lokasi }}"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <input type="number" class="form-control" name="jml_rotasi" value="{{ $sesi->jml_rotasi }}"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <input type="number" class="form-control" name="jml_station" value="{{ $sesi->jml_station }}"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <div class="input-group">
                                ...
                                <input type="text" name='tgl_ujian' class="form-control datepicker" value="{{ $sesi->tgl_ujian }}">
                            </div>
                ...
                <div class="panel-footer">
                    ...
                    <a  class="btn btn-default" href="{{ route('admin.ujian.show', $sesi->ujian_id) }}">Kembali</a>
